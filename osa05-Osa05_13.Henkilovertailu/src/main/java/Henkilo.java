...
public class Henkilo {
    ...
    public boolean equals(Object verrattava){
        ...
        Henkilo verrattavaKappale = (Henkilo) verrattava;

        // jos olioiden oliomuuttujien arvot ovat samat, ovat oliot samat
        if (this.nimi.equals(verrattavaKappale.nimi) &&
            this.syntymaPaiva.equals(verrattavaKappale.syntymaPaiva)&&
            this.pituus == verrattavaKappale.pituus &&
            this.paino == verrattavaKappale.paino) {
            return true;
        }
