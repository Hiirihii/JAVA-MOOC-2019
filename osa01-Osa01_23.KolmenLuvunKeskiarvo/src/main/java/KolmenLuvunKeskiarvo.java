...
public class KolmenLuvunKeskiarvo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Syötä kolmas luku!"); // Tulostaa pyynnön syöttää toisen luvun.
        int luku3 = Integer.valueOf(lukija.nextLine()); // Antaa muuttajalle luku2 käyttäjän syöttämän arvon.
        
        System.out.println("Syötettyjen lukujen keskiarvo on " + (1.0*luku1 + luku2 + luku3) / 3 ); // Suorittaa muuttujien yhteenlaskun ja jakaa summan muuttujien lukumäärällä ja tulostaa keskiarvon.
